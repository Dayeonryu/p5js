...
function draw() {
  ...
  if (mouseIsPressed) {
    ...
    ellipse(380, 400, 90, 200);
    ellipse(360, 300, 80, 200);
    
    ellipse(220, 400, 90, 200);
    ellipse(240, 300, 80, 200);
  }
  else {
    noStroke();
    fill(0);
